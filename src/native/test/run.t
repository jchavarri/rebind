...
Require statements, more than one statement
  ...
  external nanoff : int -> string -> int -> nanoff = "nanoff" [@@mel.module]
  external jspkgblue : string -> jspkgblue = "js-pkgblue" [@@mel.module]
  
  let nano = nanoff 5 "fsdf" 43
  let blue = jspkgblue "gf"
  ...
  var JsPkgblue = require("js-pkgblue");
  var Nanoff = require("nanoff");
  
  var nano = Nanoff(5, "fsdf", 43);
  
  var blue = JsPkgblue("gf");
...
Track identifiers across statements
  ...
  function nano(prim0, prim1, prim2) {
    return Nanoff(prim0, prim1, prim2);
  }
  
  var test = Nanoff(5, "fsdf", 43);
...
Single require
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 3, characters 11-15:
  3 | let blue = blue
                 ^^^^
...
Basic object property access
  ...
  external test : db -> int -> test = "test" [@@mel.send]
  external blue : blue = "blue" [@@mel.module]
  external pill : blue -> pill = "pill" [@@mel.get]
  external jump : pill -> int -> jump = "jump" [@@mel.send]
  ...
  17 | nano##db##test 23
       ^^^^^^^^
  Error: This expression is not an object; it has type nano
  [2]
...
Functions as callbacks
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 18, characters 0-8:
  18 | nano##db##create "foo" (fun err body headers -> ())
       ^^^^^^^^
  Error: This expression is not an object; it has type nano
  [2]
...
Object constants
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 14, characters 15-23:
  14 | let airtable = airtable;;
                      ^^^^^^^^
...
Objects, properties, callbacks, modules
  ...
  external makeSelectParam : view:string -> maxRecords:int -> unit -> selectParam
    = ""
  [@@mel.obj]
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 36, characters 15-23:
  36 | let airtable = airtable;;
                      ^^^^^^^^
  Error: Unbound value airtable
  Hint: Did you mean airtable2?
  [2]
...
Identifiers with same name
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 9, characters 12-24:
  9 | let jPush = jPush##jPush;;
                  ^^^^^^^^^^^^
...
Stripe example
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 19, characters 0-17:
  19 | stripe##customers##create [%mel.obj { email = "customer@example.com" }]
       ^^^^^^^^^^^^^^^^^
  Error: This expression is not an object; it has type stripe
  [2]
...
`new` from a module
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 7, characters 15-36:
  7 | let instance = expressionPlaceholder
                     ^^^^^^^^^^^^^^^^^^^^^
  Error: Unbound value expressionPlaceholder
  [2]
...
`new` from a module using import
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 15, characters 0-13:
  15 | statementBail
       ^^^^^^^^^^^^^
...
Named import
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 5, characters 0-13:
  5 | statementBail
      ^^^^^^^^^^^^^
  Error: Unbound value statementBail
  [2]
...
Default imports
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 18, characters 0-13:
  18 | statementBail
       ^^^^^^^^^^^^^
  Error: Unbound value statementBail
  [2]
...
Named imports with local name
  ...
  external green2 : int -> green2 = "green";;
...
Namespaced imports
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 8, characters 0-13:
  8 | statementBail
      ^^^^^^^^^^^^^
  Error: Unbound value statementBail
  [2]
...
Dots and other strange chars in import names
  ...
  external bnjs : string -> int -> bnjs = "bn.js" [@@mel.new] [@@mel.module]
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 15, characters 8-29:
  15 | let a = expressionPlaceholder
               ^^^^^^^^^^^^^^^^^^^^^
  Error: Unbound value expressionPlaceholder
  [2]
...
Function in commonJS/ES6 module
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 9, characters 0-10:
  9 | path##join "a" "b"
      ^^^^^^^^^^
...
Import entire module as a value
  ...
  external foo : int -> foo = "foo" [@@mel.module]
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 7, characters 0-5:
  7 | foo 1
      ^^^^^
...
Import ES6 module default export
  ...
  external foo : int -> foo = "default" [@@mel.module "foo"];;
...
Function scoped inside an object in a module
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 11, characters 0-8:
  11 | foo##bar##baz ()
       ^^^^^^^^
...
Overloaded function
  ...
  $ melc -ppx melppx output.ml
  File "output.ml", line 5, characters 0-11:
  5 | foo "hello";;
      ^^^^^^^^^^^
  Error (warning 109 [bucklescript-toplevel-expr-unit]): Toplevel expression is expected to have unit type.
  
  File "output.ml", line 6, characters 4-12:
  6 | foo Js.true_
          ^^^^^^^^
...
Create an object
  ...
  external makePerson : name:string -> id:int -> unit -> person = "" [@@mel.obj]
